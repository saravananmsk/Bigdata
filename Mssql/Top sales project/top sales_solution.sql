...
select fcs.cust_id,mct.territory_id, fcs.order_value,
	...
	--select * from  msk.topsales_1


--select OBJECT_ID('msk.fct_customer_sales', 'U') 
...
--((Q4sales-Q3sales)/100)*100 as SalesGrowth
select * from msk.topsales_4 ;

/*
having( sum(case when order_date1 ='Q3-2021' then order_value else 0 end) <>0
and sum(case when order_date1 ='Q4-2021' then order_value else 0  end) <>0)*/
